  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _context.next = 8;
          return _userService["default"].userHandleLogin(email, password);
        case 8:
...
var handleCreateUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          _context2.next = 7;
          return _userService["default"].createUser(dataCreate);
        case 7:
  ...
  return function handleCreateUser(_x3, _x4) {
...
var handleGetAllUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          _context3.next = 8;
          return _userService["default"].getAllUser(id);
        case 8:
  ...
  return function handleGetAllUser(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleEditUser = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var dataEdit, userData;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          _context4.next = 8;
          return _userService["default"].editUser(dataEdit);
        case 8:
...
var handleDeleteUser = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var dataDelete, userData;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          dataDelete = req.body.id;
          if (dataDelete) {
            _context5.next = 5;
            break;
          }
        ...
        case 5:
          _context5.next = 7;
          return _userService["default"].deleteUser(dataDelete);
        case 7:
  ...
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 6:
          _context6.next = 8;
          return _userService["default"].getAllCodeService(type);
        case 8:
          dataAllCode = _context6.sent;
