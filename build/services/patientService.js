...
var buildUrlVerify = function buildUrlVerify(doctorId, token) {
  var result = "".concat(process.env.EMAIL_VERIFY, "/verify-booking?doctorId=").concat(doctorId, "&token=").concat(token);
  return result;
};
var handlePatientBooking = function handlePatientBooking(dataBooking) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var fieldRequire, haveDatas, token, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            fieldRequire = ['email', 'name', 'phone', 'gender', 'address', 'doctorId', 'date', 'timeType'];
            haveDatas = fieldRequire.every(function (field) {
          ...
          case 7:
            token = (0, _uuid.v4)();
            _context.next = 10;
            return (0, _mailService.sendEmail)({
...
var handleVerifyEmailBooking = function handleVerifyEmailBooking(dataVerify) {
  return new Promise( /*#__PURE__*/function () {
...
var handleGetAllBooking = function handleGetAllBooking(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
          ...
          case 5:
            ...
            return _models["default"].Booking.findAll({
              ...
              include: [{
                ...
                as: 'patientData',
                attributes: {
                  exclude: ['id', 'firstName', 'password', 'roleID', 'positionID', 'image', 'createdAt', 'updatedAt']
                },
                include: {
...
module.exports = {
  handlePatientBooking: handlePatientBooking,
  handleVerifyEmailBooking: handleVerifyEmailBooking,
