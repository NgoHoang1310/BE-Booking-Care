...
var handleCreateClinic = function handleCreateClinic(dataCreate) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!dataCreate.name || !dataCreate.address || !dataCreate.image || !dataCreate.banner || !dataCreate.introductionHTML || !dataCreate.descriptionMarkdown || !dataCreate.descriptionHTML)) {
              _context.next = 5;
              break;
            }
            resolve({
...
var handleGetAllClinic = function handleGetAllClinic() {
  return new Promise( /*#__PURE__*/function () {
...
var handleEditClinic = function handleEditClinic(dataEdit) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            if (!(!dataEdit.id || !dataEdit.name || !dataEdit.image || !dataEdit.banner || !dataEdit.descriptionHTML || !dataEdit.descriptionMarkdown || !dataEdit.introductionHTML || !dataEdit.address)) {
              _context3.next = 5;
              break;
            }
            resolve({
          ...
          case 5:
            _context3.next = 7;
            return _models["default"].Clinic.update({
              name: dataEdit.name,
...
var handleDeleteClinic = function handleDeleteClinic(dataDelete) {
  return new Promise( /*#__PURE__*/function () {
...
var handleGetDetailClinic = function handleGetDetailClinic(clinicId) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var detailClinic, doctors;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 7:
            detailClinic = _context5.sent;
            if (!detailClinic) {
              _context5.next = 13;
              break;
            }
            _context5.next = 11;
            return _models["default"].Doctor_Info.findAll({
              where: {
                clinicID: clinicId
              }
            });
