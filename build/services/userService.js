...
var userHandleLogin = function userHandleLogin(email, password) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var userData, existUser, user, _password, newUser;
          ...
          case 8:
            ...
            if (user) {
              if (user.password === password) {
                userData.errCode = 0;
                userData.message = 'OK';
                _password = user.password, newUser = _objectWithoutProperties(user, _excluded);
...
var checkEmailExist = function checkEmailExist(email) {
  return new Promise( /*#__PURE__*/function () {
...
var createUser = function createUser(dataCreate) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return checkEmailExist(dataCreate.email);
          case 3:
...
var editUser = function editUser(dataEdit) {
  return new Promise( /*#__PURE__*/function () {
...
//     })
// }
var deleteUser = function deleteUser(dataDelete) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ...
            data = {};
            _context7.next = 4;
            return _models["default"].Allcode.findAll({
              where: {
                type: typeInput
              }
            });
          case 4:
            allCode = _context7.sent;
            console.log(allCode);
            if (allCode.length != 0) {
              data.errCode = 0;
