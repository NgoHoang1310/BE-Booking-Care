...
var MAX_SCHEDULE_NUMBER = process.env.MAX_SCHEDULE_NUMBER;
var handleGetOutstandingDoctor = function handleGetOutstandingDoctor(limit) {
...
var handleGetAllDoctor = function handleGetAllDoctor() {
  return new Promise( /*#__PURE__*/function () {
...
var handleSaveInfoDoctor = function handleSaveInfoDoctor(inforDoctor) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            if (!(!inforDoctor.action || !inforDoctor.id || !inforDoctor.contentHTML || !inforDoctor.contentMarkdown || !inforDoctor.description || !inforDoctor.clinicName || !inforDoctor.addressClinic || !inforDoctor.price || !inforDoctor.payment || !inforDoctor.province || !inforDoctor.specialty || !inforDoctor.clinic)) {
              _context3.next = 5;
              break;
            }
            resolve({
          ...
          case 14:
            checkDoctorInfo = _context3.sent;
            ...
            _context3.next = 19;
            return _models["default"].Doctor_Info.update({
...
var handleGetDetailDoctor = function handleGetDetailDoctor(doctorId) {
  return new Promise( /*#__PURE__*/function () {
...
var handleCreateSchedule = function handleCreateSchedule(dataSchedule) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var existSchedule, toCreate;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            dataSchedule = dataSchedule.map(function (item) {
          ...
          case 5:
            existSchedule = _context5.sent;
            if (!(existSchedule && existSchedule.length > 0)) {
              _context5.next = 19;
              break;
            }
            existSchedule = existSchedule.map(function (item) {
              item.date = new Date(1673370000000).getTime();
              return item;
            });

            //kiểm tra tồn tại
            toCreate = _lodash["default"].differenceWith(dataSchedule, existSchedule, function (a, b) {
          ...
          case 19:
            _context5.next = 21;
            return _models["default"].Schedule.bulkCreate(dataSchedule);
          case 21:
            resolve({
              errCode: 0,
              message: "Success",
...
var handlegetScheduleByDoctor = function handlegetScheduleByDoctor(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
var handleGetExtraDoctorInfo = function handleGetExtraDoctorInfo(doctorId) {
  return new Promise( /*#__PURE__*/function () {
...
var handleConfirmRemedy = function handleConfirmRemedy(dataRemedy) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ...
            if (!(0, _lodash.isEmpty)(dataRemedy)) {
              _context9.next = 6;
              break;
            }
            resolve({
          ...
          case 6:
            _context9.next = 8;
            return (0, _mailService.sendEmailRemery)(dataRemedy);
          case 8:
            _context9.next = 10;
...
module.exports = {
  handleGetOutstandingDoctor: handleGetOutstandingDoctor,
